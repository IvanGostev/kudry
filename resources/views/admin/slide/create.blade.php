    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-dark card-outline mb-4">
                <!--begin::Header-->
                <div class="card-header"><div class="card-title">Добавление слайда</div></div>
                <!--end::Header-->
                <!--begin::Form-->
                <form action="{{route('admin.slide.store')}}" enctype="multipart/form-data" method="post" >
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Информация</label>
                            <input type="text" name="info" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
