            ...
            <nav class="mt-2">
                ...
                >
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('admin.text.create')}}" class="nav-link">
                                    <i class="nav-icon bi bi-circle"></i>
                                    <p>Добавление</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('admin.seo.create')}}" class="nav-link">
                                    <i class="nav-icon bi bi-circle"></i>
                                    <p>Добавление</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('admin.report.create')}}" class="nav-link">
                                    <i class="nav-icon bi bi-circle"></i>
                                    <p>Добавление</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('admin.detail.index')}}" class="nav-link">
                                    <i class="nav-icon bi bi-circle"></i>
                                    <p>Список</p>
                                </a>
                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('admin.detail.create')}}" class="nav-link">
                                    <i class="nav-icon bi bi-circle"></i>
                                    <p>Добавление</p>
                                </a>
                            </li>
